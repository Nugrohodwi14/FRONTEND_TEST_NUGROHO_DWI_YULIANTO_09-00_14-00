<template>
  <form action="" class="form" @submit="checkLogin">
    ...
    <div class="form__group">
      ...
      <input type="email" class="form__input" :class="{
        valid: emailValid,
        notValid: !emailValid,
      }" placeholder="you@company.com" id="Email" required @change="checkEmail" v-model="email" />
      <p class="errorMassage" :class="{
        disable: !emailValid,
        disable: emailValid,
      }" id="emailError">
    ...
    <div class="form__group">
      ...
      <input type="password" class="form__input valid" placeholder="8+ Characters" id="Password" required @change="
        passwordTouched = true;
      checkPassword();
      " @keyup="checkPassword" v-model="password" />
      <p class="errorMassage disable" id="passwordError">
        Password must be 6 characters or more
      </p>
    </div>
    <button class="form__btn" id="submit" :disabled="!isValid" :class="{ avalible: isValid, notAvalible: !isValid }">
      Login
    </button>
  </form>
  <div class="linking">
...
export default {
  ...
  data() {
    return {
      ...
      accounts: [
        { email: "nugi@gmail.com", password: "A12345678" },
      ],
    };
  },
